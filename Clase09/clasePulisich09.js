...
let limpiarCarro= document.getElementsByClassName("btn-danger")
for (let i=0; i < limpiarCarro.length; i++){
    let boton= limpiarCarro[i];
    boton.addEventListener("click", function(evento){
        botonClick= evento.target
        botonClick.parentElement
    })
}

agregarCarro= document.getElementById("botonCompra1")
agregarCarro.onclick = () => {
    document.getElementById("itemsCarro")
console.log("Producto 1 agregado al carro")
}; //Después ver bien cómo asociar productos a botones.
